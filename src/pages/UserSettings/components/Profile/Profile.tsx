...
export default function Profile() {
    ...
    return (
        <section className="flex flex-col gap-10">
            <ProfileHeader inEditMode={inEditMode} setEditMode={setInEditMode} achievementsMap={achievementsMap} />
            <About inEditMode={inEditMode}/>
            <LearningGoals inEditMode={inEditMode} />
            <GeneralStatistics />
            <Achievements achievementsMap={achievementsMap} />
        </section>
    )
}